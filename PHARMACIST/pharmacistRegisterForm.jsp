...
<body>
    <div class="container">
        ...
        <form name="clerkRegisterForm" action="pharmacistRegisterInsert.jsp" method="post" onsubmit="return validate()">
            <table>
                <tr>
                    <td>Login ID:</td>
                ...
                <tr>
                    <td colspan="2">
                        <input type="submit" name="submitRegistrationPharmacist" value="Register">
